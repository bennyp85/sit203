            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center text-muted"><a href="register.php"><strong>Register now</strong></a>
            ...
            <div class="collapse clearfix" id="search">
                ...
                <form class="navbar-form" role="search">
                    <div class="input-group" id="livesearch">
                        <input type="text" class="form-control dropdown" data-toggle="dropdown" onkeyup="showResult(this.value)" placeholder="Search">
                        <div id="txtHint" class="dropdownme">
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li>
                                    <a href="shop-furniture.php">furniture <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a href="shop-furniture.php">Chairs</a>
                                        </li>
                                        <li><a href="shop-furniture.php">Beds</a>
                                ...
                                <li class="active">
                                    <a href="shop-accessories.php">Accessories  <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a href="shop-accessories.php">Home Deco</a>
                                        </li>
                                        <li><a href="shop-accessories.php">Textiles & Rugs</a>
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Chair</a></h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Table</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="detail.php" class="btn btn-default">View detail</a>
                                        <a href="basket.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
