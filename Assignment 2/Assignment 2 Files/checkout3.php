...
<body>
  <?php
    // two connection to DB wont work ?
    include "ps.php";
    ...
    if (!$connect)  {
      ...
      exit;
        ...
        $query_count = "SELECT max(ID) FROM banking";
     ...
     //insert input values into contact table
       $query = "INSERT INTO banking (ID, cardname, cardnumber, expmonth, expyear, cvv ) VALUES ($count, '$cardname', '$cardnumber', '$expmonth','$expyear', '$cvv')";
