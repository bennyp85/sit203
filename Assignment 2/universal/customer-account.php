                    ...
                    <div class="box">
                        ...
                        <form>
                            ...
                            <div class="col-sm-12 text-center">
                                <button type="submit" method="post" class="btn btn-primary"><i class="fa fa-save"></i> Save new password</button>
                            </div>
                        </form>
                        ...
                        <form>
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-6">
                                  ...
                                  <div class="col-sm-12 text-center">
                                      <button type="submit" method="post" class="btn btn-primary"><i class="fa fa-save"></i> Save changes</button>
